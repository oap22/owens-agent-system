...
| [Claude Code subagents](https://code.claude.com/docs/en/sub-agents), [model configuration](https://code.claude.com/docs/en/model-config), [CLI reference](https://code.claude.com/docs/en/cli-reference) | Subagent `model`, `effort`, `tools`, `maxTurns`; `--effort`; inline `--agents`; fresh subagent context returning only its final message | Documentation-checked on 2026-09-07; no live run of the delegation path in this repository |
