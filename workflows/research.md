...
7. Synthesize the answer with uncertainty and a concrete next experiment. Mark each claim you could not confirm and say where you looked. Verify each material citation supports the sentence attached to it. Source-linked generated notes are not proof Owen learned the material.
