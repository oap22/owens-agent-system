...
6. Synthesize the answer with uncertainty and a concrete next experiment. Verify each material citation supports the sentence attached to it. Source-linked generated notes are not proof Owen learned the material.
